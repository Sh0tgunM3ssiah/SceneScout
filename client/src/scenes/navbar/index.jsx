...
import { setMode } from "state"; // Assuming you have this action
...
const Navbar = () => {
    ...
    const handleLogout = async () => {
        try {
            await signOut();
            dispatch({ type: 'USER_LOGOUT' }); // Dispatch an appropriate action to clear user state
            navigate('/login'); // Or wherever you'd like to redirect after logout
        } catch (error) {
